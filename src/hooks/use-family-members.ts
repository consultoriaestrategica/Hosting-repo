...
export type FamilyMember = {
  ...
  name: string;
  residentId: string;
  residentName: string; // Nombre del residente para mostrar
  relationship: string; // "Hijo/a", "Esposo/a", "Hermano/a", etc.
  phone?: string;
  isActive: boolean;
  createdAt: Date;
  updatedAt?: Date;
...
export function useFamilyMembers() {
  ...
  const addFamilyMember = useCallback(
    async (
      ...
      try {
        ...
        // 3. Cerrar sesión del usuario recién creado para que el admin siga logueado
  ...
  // Función para que un familiar inicie sesión
